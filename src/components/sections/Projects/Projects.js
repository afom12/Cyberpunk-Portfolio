...
const Projects = () => {
  ...
  const projectsData = [
    ...
    {
      id: 6,
      title: "FastDelivery Web",
      description: "A frontend web interface for a food delivery platform, enabling customers to browse restaurants and order food efficiently.",
      technologies: ["React", "Tailwind CSS"],
      liveUrl: "#",
      githubUrl: "https://github.com/afom12/Fast_Delivery.git",
      category: "WEB APP",
      status: "ACTIVE",
      image: "hologram-6",
    },
    {
      id: 7,
      title: "MindCare AI",
      description: "A mental health support platform combining assessments and guided assistance to help users track and improve their wellbeing.",
      technologies: ["React", "Node.js"],
      liveUrl: "#",
      githubUrl: "https://github.com/afom12/mindcare.git", // TODO: add your real GitHub link
      category: "WEB APP",
      status: "IN PROGRESS",
      image: "hologram-7",
    },
    {
      id: 8,
      title: "Smart Campus",
      description: "A campus-focused web platform designed to streamline everyday student and university services.",
      technologies: ["React", "Node.js"],
      liveUrl: "#",
      githubUrl: "#", // TODO: add your real GitHub link
      category: "WEB APP",
      status: "IN PROGRESS",
      image: "hologram-8",
    },
    {
      id: 9,
      title: "DevGenie",
      description: "A developer-focused tool built to help streamline parts of the software development workflow.",
      technologies: ["React", "Node.js"],
      liveUrl: "#",
      githubUrl: "#", // TODO: add your real GitHub link
      category: "TOOLS",
